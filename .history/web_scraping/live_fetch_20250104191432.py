        ...
        for row in rows:
            ...
            if row_date.date() == match_date.date():
                ...
                if row_data:
                    ...
                    with open(output_file_general, mode="w", newline="", encoding="utf-8") as general_file:
                ...
                with open(output_file_home, mode="w", newline="", encoding="utf-8") as home_file:
                ...
                if len(tables) >= 8:
                        ...
                        #away_players = []
                        with open(output_file_away, mode="w", newline="", encoding="utf-8") as away_file:
